...
OutIterator transform_exclusive_scan(Iterator beg, Iterator end, OutIterator out, T init, Combine c, Transform t)
{
    for (;beg != end-1; ++beg)
    {
        *out++ = init;
...
struct Servant : boost::asynchronous::trackable_servant<>
{
    ...
    boost::shared_future<void> test_transform_exclusive_scan()
    {
        ...
        post_callback(
           [ids,this](){
                    ...
                    return boost::asynchronous::parallel_transform_exclusive_scan(
...
public:
    ...
    {}
    BOOST_ASYNC_FUTURE_MEMBER(test_transform_exclusive_scan)
};
}

BOOST_AUTO_TEST_CASE( test_transform_exclusive_scan )
{
    servant_dtor=false;
    {
        ...
        boost::shared_future<boost::shared_future<void> > fuv = proxy.test_transform_exclusive_scan();
        try
        {
