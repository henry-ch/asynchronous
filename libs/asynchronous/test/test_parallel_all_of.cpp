...
struct Servant : boost::asynchronous::trackable_servant<>
{
    ...
    boost::shared_future<void> start_parallel_all_of_true()
    {
    ...
    boost::shared_future<void> start_parallel_all_of_false()
    {
...
BOOST_AUTO_TEST_CASE( test_parallel_all_of_true )
{
    servant_dtor=false;
    {
        ...
        boost::shared_future<boost::shared_future<void> > fuv = proxy.start_parallel_all_of_true();
        try
        {
