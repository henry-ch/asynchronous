...
struct Servant : boost::asynchronous::trackable_servant<>
{
    ...
    boost::shared_future<void> test_reverse_even()
    {
    ...
    boost::shared_future<void> test_reverse_odd()
    {
        BOOST_CHECK_MESSAGE(main_thread_id!=boost::this_thread::get_id(),"servant async work not posted.");
...
BOOST_AUTO_TEST_CASE( test_reverse_even )
{
    servant_dtor=false;
    {
        ...
        boost::shared_future<boost::shared_future<void> > fuv = proxy.test_reverse_even();
        try
        {
