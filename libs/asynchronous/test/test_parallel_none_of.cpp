...
struct Servant : boost::asynchronous::trackable_servant<>
{
    ...
    std::future<void> start_parallel_none_of_true()
    {
    ...
    std::future<void> start_parallel_none_of_false()
    {
    ...
    std::future<void> start_parallel_none_of_continuation()
    {
...
BOOST_AUTO_TEST_CASE( test_parallel_none_of_true )
{
    servant_dtor=false;
    {
        ...
        auto fuv = proxy.start_parallel_none_of_true();
        try
        {
            auto resfuv = fuv.get();
            resfuv.get();
...
BOOST_AUTO_TEST_CASE( test_parallel_none_of_false )
{
    servant_dtor=false;
    {
        ...
        main_thread_id = boost::this_thread::get_id();
        ServantProxy proxy(scheduler);
        auto fuv = proxy.start_parallel_none_of_false();
        try
        {
            auto resfuv = fuv.get();
            resfuv.get();
...
BOOST_AUTO_TEST_CASE( test_parallel_none_of_continuation )
{
    servant_dtor=false;
    {
        ...
        main_thread_id = boost::this_thread::get_id();
        ServantProxy proxy(scheduler);
        auto fuv = proxy.start_parallel_none_of_continuation();
        try
        {
            auto resfuv = fuv.get();
            resfuv.get();
