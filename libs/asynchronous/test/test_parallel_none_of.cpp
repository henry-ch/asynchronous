...
struct Servant : boost::asynchronous::trackable_servant<>
{
    ...
    boost::future<void> start_parallel_none_of_true()
    {
    ...
    boost::future<void> start_parallel_none_of_false()
    {
    ...
    boost::future<void> start_parallel_none_of_continuation()
    {
...
BOOST_AUTO_TEST_CASE( test_parallel_none_of_true )
{
    servant_dtor=false;
    {
        ...
        boost::future<boost::future<void> > fuv = proxy.start_parallel_none_of_true();
        try
        {
...
BOOST_AUTO_TEST_CASE( test_parallel_none_of_false )
{
    servant_dtor=false;
    {
        ...
        main_thread_id = boost::this_thread::get_id();
        ServantProxy proxy(scheduler);
        boost::future<boost::future<void> > fuv = proxy.start_parallel_none_of_false();
        try
        {
            boost::future<void> resfuv = fuv.get();
            resfuv.get();
...
BOOST_AUTO_TEST_CASE( test_parallel_none_of_continuation )
{
    servant_dtor=false;
    {
        ...
        main_thread_id = boost::this_thread::get_id();
        ServantProxy proxy(scheduler);
        boost::future<boost::future<void> > fuv = proxy.start_parallel_none_of_continuation();
        try
        {
            boost::future<void> resfuv = fuv.get();
            resfuv.get();
