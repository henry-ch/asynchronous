...
BOOST_AUTO_TEST_CASE( test_vector_move_ctor_std )
{
    {
        boost::asynchronous::vector<some_type> vorg(10000 /* number of elements */);
        boost::asynchronous::vector<some_type> v(std::move(vorg));
        BOOST_CHECK_MESSAGE(v.size()==10000,"vector size should be 10000.");
...
BOOST_AUTO_TEST_CASE( test_vector_copy_ctor_std )
{
    {
        boost::asynchronous::vector<some_type> vorg(10000 /* number of elements */);
        boost::asynchronous::vector<some_type> v(vorg);
...
BOOST_AUTO_TEST_CASE( test_vector_access_std )
{
    boost::asynchronous::vector<some_type> v(10000 /* number of elements */);
    BOOST_CHECK_MESSAGE(v.size()==10000,"vector size should be 10000.");
    v[500].data = 10;
...
BOOST_AUTO_TEST_CASE( test_vector_at_ok_std )
{
    boost::asynchronous::vector<some_type> v(10000 /* number of elements */);
    BOOST_CHECK_MESSAGE(v.size()==10000,"vector size should be 10000.");
    v.at(500).data = 10;
...
BOOST_AUTO_TEST_CASE( test_vector_at_nok_std )
{
    {
        boost::asynchronous::vector<some_type> v(10000 /* number of elements */);
        BOOST_CHECK_MESSAGE(v.size()==10000,"vector size should be 10000.");
...
BOOST_AUTO_TEST_CASE( test_vector_front_back_std )
{
    {
        boost::asynchronous::vector<some_type> v(10000 /* number of elements */);
        BOOST_CHECK_MESSAGE(v.size()==10000,"vector size should be 10000.");
...
BOOST_AUTO_TEST_CASE( test_vector_clear_std )
{
    {
        boost::asynchronous::vector<some_type> v(10000 );
        BOOST_CHECK_MESSAGE(v.size()==10000,"vector size should be 10000.");
        v.clear();
        BOOST_CHECK_MESSAGE(v.size() == 0,"vector.size() should have value 0.");
        BOOST_CHECK_MESSAGE(v.empty(),"vector.empty() should be true.");
...
BOOST_AUTO_TEST_CASE( test_vector_push_back_no_realloc_std )
{
    {
        boost::asynchronous::vector<some_type> v;
        BOOST_CHECK_MESSAGE(v.size()==0,"vector size should be 0.");
...
BOOST_AUTO_TEST_CASE( test_vector_push_back_realloc_std )
{
    {
        auto scheduler = boost::asynchronous::make_shared_scheduler_proxy<boost::asynchronous::multiqueue_threadpool_scheduler<
                                                                            boost::asynchronous::lockfree_queue<>>>(8);
...
BOOST_AUTO_TEST_CASE( test_vector_emplace_back_no_realloc_std )
{
    {
        auto scheduler = boost::asynchronous::make_shared_scheduler_proxy<boost::asynchronous::multiqueue_threadpool_scheduler<
                                                                            boost::asynchronous::lockfree_queue<>>>(8);
...
BOOST_AUTO_TEST_CASE( test_vector_swap_std )
{
    {
        boost::asynchronous::vector<some_type> v;
...
BOOST_AUTO_TEST_CASE( test_vector_reserve_std )
{
    {
        boost::asynchronous::vector<some_type> v;
        v.push_back(some_type(41));
...
BOOST_AUTO_TEST_CASE( test_vector_shrink_to_fit_std )
{
    {
        boost::asynchronous::vector<some_type> v;
        v.push_back(some_type(41));
...
BOOST_AUTO_TEST_CASE( test_vector_iterators_std )
{
    {
        boost::asynchronous::vector<some_type> v;
        v.push_back(some_type(1));
...
BOOST_AUTO_TEST_CASE( test_vector_resize_std)
{
    {
        boost::asynchronous::vector<some_type> v(10000 );
        v.resize(10000);
...
BOOST_AUTO_TEST_CASE( test_vector_assignment_operator_to_smaller_std )
{
    {
        boost::asynchronous::vector<some_type> v(10000 );
        boost::asynchronous::vector<some_type> v2(5000);
...
BOOST_AUTO_TEST_CASE( test_vector_assignment_operator_to_larger_std )
{
    {
        boost::asynchronous::vector<some_type> v(5000 /* number of elements */);
        boost::asynchronous::vector<some_type> v2(10000 /* number of elements */);
...
BOOST_AUTO_TEST_CASE( test_vector_assignment_to_smaller_std )
{
    {
        boost::asynchronous::vector<some_type> v(10000 /* number of elements */);
        std::vector<some_type> v2( 5000 /* number of elements */);
...
BOOST_AUTO_TEST_CASE( test_vector_assignment_to_larger_std )
{
    {
        boost::asynchronous::vector<some_type> v(5000 /* number of elements */);
        std::vector<some_type> v2( 10000 /* number of elements */);
...
BOOST_AUTO_TEST_CASE( test_vector_assignment2_to_smaller_std )
{
    {
        boost::asynchronous::vector<some_type> v(10000 /* number of elements */);
        v.assign(std::size_t(5000),42);
...
BOOST_AUTO_TEST_CASE( test_vector_assignment2_to_larger_std )
{
    {
        boost::asynchronous::vector<some_type> v(5000 /* number of elements */);
        v.assign(std::size_t(10000),42);
...
BOOST_AUTO_TEST_CASE( test_vector_equal_std )
{
    boost::asynchronous::vector<some_type> v(5000 /* number of elements */);
    boost::asynchronous::vector<some_type> v2(5000 /* number of elements */);
    boost::asynchronous::vector<some_type> v3(5000 /* number of elements */, some_type(42));
    boost::asynchronous::vector<some_type> v4(4000 /* number of elements */);
...
BOOST_AUTO_TEST_CASE( test_vector_compare_std )
{
    boost::asynchronous::vector<some_type> v1(5000 /* number of elements */, some_type(42));
    boost::asynchronous::vector<some_type> v2(5000 /* number of elements */, some_type(42));
    boost::asynchronous::vector<some_type> v3(5000 /* number of elements */, some_type(42));
    ++v1[2000].data;
...
BOOST_AUTO_TEST_CASE( test_vector_erase_std)
{
    {
        boost::asynchronous::vector<some_type> v;
        for (auto i = 0; i < 10000; ++i)
...
BOOST_AUTO_TEST_CASE( test_vector_insert_std)
{
    {
        boost::asynchronous::vector<some_type> v;
        for (auto i = 0; i < 10000; ++i)
