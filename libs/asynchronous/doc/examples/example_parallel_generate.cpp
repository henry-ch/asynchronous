...
struct Servant : boost::asynchronous::trackable_servant<>
{
    ...
    void on_callback()
    {
        ...
        std::cout << "The following values should be random." << std::endl;
    ...
    boost::shared_future<void> start_async_work()
    {
        ...
        post_callback(
               [this](){
                        return boost::asynchronous::parallel_generate(this->m_data.begin(), this->m_data.end(), std::rand, 1500);
                      },// work
...
{
    std::cout << "example_generate" << std::endl;
    {
    ...
    std::cout << "end example_generate" << std::endl << std::endl;
}
