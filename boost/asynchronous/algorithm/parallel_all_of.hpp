...
#ifndef BOOST_ASYNCHRONOUS_PARALLEL_ALL_OF_HPP
#define BOOST_ASYNCHRONOUS_PARALLEL_ALL_OF_HPP
...
parallel_all_of(Iterator beg, Iterator end,Func func,long cutoff,
...
struct parallel_all_of_continuation_range_helper: public boost::asynchronous::continuation_task<bool>
{
    parallel_all_of_continuation_range_helper(Continuation c,Func func,long cutoff,
                        const std::string& task_name, std::size_t prio)
...
typename boost::enable_if<boost::asynchronous::detail::has_is_continuation_task<Range>,boost::asynchronous::detail::callback_continuation<bool,Job> >::type
...
{
    return boost::asynchronous::top_level_callback_continuation_job<bool,Job>
            (boost::asynchronous::detail::parallel_all_of_continuation_range_helper<Range,Func,Job>(range,std::move(func),cutoff,task_name,prio));
}
}}
#endif // BOOST_ASYNCHRONOUS_PARALLEL_ALL_OF_HPP
