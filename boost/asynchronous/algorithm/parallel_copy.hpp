...
#ifndef BOOST_ASYNCHRONOUS_PARALLEL_COPY_HPP
#define BOOST_ASYNCHRONOUS_PARALLEL_COPY_HPP
...
struct parallel_copy_helper : public boost::asynchronous::continuation_task<void>
{
    parallel_copy_helper(Iterator begin, Iterator end, ResultIterator result, long cutoff, std::string const & task_name, std::size_t prio)
...
parallel_copy(Iterator begin, Iterator end, ResultIterator result, long cutoff,
...
#endif
{
    return boost::asynchronous::top_level_callback_continuation_job<void, Job>
               (boost::asynchronous::detail::parallel_copy_helper<Iterator, ResultIterator, Job>(begin, end, result, cutoff, task_name, prio));
}
...
struct parallel_copy_range_move_helper: public boost::asynchronous::continuation_task<Range>
{
    parallel_copy_range_move_helper(boost::shared_ptr<Range> range, ResultIterator out, long cutoff,
                        const std::string& task_name, std::size_t prio)
        :boost::asynchronous::continuation_task<Range>(task_name)
        ,range_(range),out_(out),cutoff_(cutoff),prio_(prio)
    {
    }
    parallel_copy_range_move_helper(parallel_copy_range_move_helper&&)=default;
    parallel_copy_range_move_helper& operator=(parallel_copy_range_move_helper&&)=default;
...
#endif
{
    ...
    return boost::asynchronous::top_level_callback_continuation_job<Range, Job>
            (boost::asynchronous::detail::parallel_copy_range_move_helper<Range, ResultIterator, Job>
...
struct parallel_copy_continuation_range_helper: public boost::asynchronous::continuation_task<typename Continuation::return_type>
{
    parallel_copy_continuation_range_helper(Continuation const& c, ResultIterator out, long cutoff,
                        const std::string& task_name, std::size_t prio)
...
struct parallel_copy_continuation_range_helper<Continuation, ResultIterator, Job, typename ::boost::enable_if< has_is_callback_continuation_task<Continuation> >::type>
...
#endif
{
    return boost::asynchronous::top_level_callback_continuation_job<typename Range::return_type,Job>
            (boost::asynchronous::detail::parallel_copy_continuation_range_helper<Range,ResultIterator,Job>(range,out,cutoff,task_name,prio));
}

}}

#endif // BOOST_ASYNCHRONOUS_PARALLEL_COPY_HPP
