...
#ifndef BOOST_ASYNCHRONOUS_GEOMETRY_ALGORITHMS_DETAIL_OVERLAY_GET_TURNS_HPP
...
>
struct parallel_section_visitor
{
    int m_source_id1;
    ...
    parallel_section_visitor(){}
    //TODO remove
  /*  parallel_section_visitor(parallel_section_visitor const& rhs)
        : m_source_id1(rhs.m_source_id1), m_geometry1(rhs.m_geometry1)
        , m_source_id2(rhs.m_source_id2), m_geometry2(rhs.m_geometry2)
        , m_rescale_policy(rhs.m_rescale_policy)
        , m_interrupt_policy(rhs.m_interrupt_policy)
    {}*/
    parallel_section_visitor(int id1, Geometry1 const& g1,
    ...
    parallel_section_visitor clone()const
    {
        ...
        clone.m_source_id2 = m_source_id2;
    ...
    inline void merge(parallel_section_visitor& rhs)
    {
        std::move(rhs.m_turns.begin(),rhs.m_turns.end(),std::back_inserter(m_turns));
    }
...
>
struct convert_visitor_to_turns : public boost::asynchronous::continuation_task<Turns>
{
    convert_visitor_to_turns(Continuation const& c)
        : boost::asynchronous::continuation_task<Turns>("geometry::convert_visitor_to_turns")
        , cont_(c)
    {}
    void operator()()
    {
        boost::asynchronous::continuation_result<Turns> task_res = this->this_task_result();
...
<
    ...
    typename Job
>
class parallel_get_turns_generic
{

public:
    template <typename RobustPolicy, typename Turns, typename InterruptPolicy>
    static inline boost::asynchronous::detail::callback_continuation<Turns,Job>
    apply(
            ...
            long partition_cutoff)
    {
        ...
        typedef parallel_section_visitor
            ...
            > Policy;
        Policy visitor(source_id1, geometry1, source_id2, geometry2, robust_policy, turns, interrupt_policy);

        return boost::asynchronous::top_level_callback_continuation_job<Turns,Job>(
...
<
    ...
    typename Job
>
struct parallel_get_turns
    : detail::get_turns::parallel_get_turns_generic
        <
            Geometry1, Geometry2,
            Reverse1, Reverse2,
            TurnPolicy,Job
...
<
    ...
    typename InterruptPolicy
>
inline boost::asynchronous::detail::callback_continuation<Turns,Job>
parallel_get_turns(Geometry1 const& geometry1,
            ...
            long partition_cutoff)
{
    ...
    return dispatch::parallel_get_turns
    <
...
#endif // BOOST_ASYNCHRONOUS_GEOMETRY_ALGORITHMS_DETAIL_OVERLAY_GET_TURNS_HPP
