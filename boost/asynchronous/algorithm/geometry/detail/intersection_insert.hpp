...
#ifndef BOOST_ASYNCHRONOUS_GEOMETRY_ALGORITHMS_DETAIL_OVERLAY_INTERSECTION_INSERT_HPP
...
struct parallel_intersection_segment_segment_point
{
    template
    <
...
template <typename PointOut>
struct parallel_intersection_linestring_linestring_point
{
    template
    <
...
>
struct parallel_intersection_of_linestring_with_areal
{
...
>
struct parallel_intersection_insert
{
...
<
    ...
    bool Reverse1, bool Reverse2, bool ReverseOut
>
struct parallel_intersection_insert_reversed
{
    template <typename RobustPolicy, typename OutputIterator, typename Strategy>
    ...
    {
        return parallel_intersection_insert
            <
...
#endif // BOOST_ASYNCHRONOUS_GEOMETRY_ALGORITHMS_DETAIL_OVERLAY_INTERSECTION_INSERT_HPP
