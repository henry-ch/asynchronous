...
struct parallel_none_of_continuation_range_helper: public boost::asynchronous::continuation_task<bool>
{
    parallel_none_of_continuation_range_helper(Continuation c,Func func,long cutoff,
...
{
    return boost::asynchronous::top_level_callback_continuation_job<bool,Job>
            (boost::asynchronous::detail::parallel_none_of_continuation_range_helper<Range,Func,Job>(range,std::move(func),cutoff,task_name,prio));
}
}}
